...
typedef struct {
  ...
  BOOL		mutable;
  BOOL		didUnique;
  void		(*debImp)(NSData*, SEL, void*, NSUInteger, unsigned*);
  unsigned int	(*deiImp)(NSData*, SEL, unsigned*);
  GSIArray_t	array;
} _NSDeserializerInfo;
...
initDeserializerInfo(_NSDeserializerInfo* info, NSData *d, unsigned *c, BOOL m)
{
  ...
  info->cursor = c;
  info->mutable = m;
  info->debImp = (void (*)(NSData*, SEL, void*, NSUInteger, unsigned*))[d methodForSelector: debSel];
  info->deiImp = (unsigned int (*)(NSData*, SEL, unsigned*))[d methodForSelector: deiSel];
